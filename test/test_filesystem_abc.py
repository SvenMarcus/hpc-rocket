...
class FilesystemTest(ABC):
    ...
    def assert_file_content_equals(self, filesystem: Filesystem, path: str, content: str):
        assert self.get_file_content(filesystem, path) == content

    def test__when_copying_file__should_copy_to_target_path(self):
    ...
    def test__when_copying_file__but_parent_dir_missing__should_create_missing_dirs(self):
    ...
    def test__a__when_copying_directory__should_copy_entire_directory(self):
        src_dir = "mydir"
        copy_dir = "copydir"
        sut = self.create_filesystem()
    ...
    def test__when_copying_file_to_other_filesystem__should_call_copy_file(self):
    ...
    def test__when_copying_file_to_other_filesystem__but_parent_dir_missing__should_create_missing_dirs(self):
        complete_path = "another/folder/" + self.TARGET
    ...
    def test__when_copying__but_source_does_not_exist__should_raise_file_not_found_error(self):
        sut = self.create_filesystem()

        with pytest.raises(FileNotFoundError):
            sut.copy(self.SOURCE, self.TARGET)

    def test__when_copying__but_file_exists__should_raise_file_exists_error(self):
        sut = self.create_filesystem()
        self.create_file(sut, self.SOURCE)
    ...
    def test__when_copying_to_existing_path_with_overwrite_enabled__should_copy_file(self):
        sut = self.create_filesystem()
    ...
    def test__when_copying_to_other_filesystem__but_file_exists__should_raise_file_exists_error(self):
        sut = self.create_filesystem()
        self.create_file(sut, self.SOURCE)
    ...
    def test__when_copying_to_existing_path_on_other_filesystem_with_overwrite_enabled__should_copy_file(self):
        target_fs = self.create_filesystem()
    ...
    def test__when_copying_directory_to_other_filesystem__should_copy_dir(self):
        source_dir = "mydir"
        target_dir = "copydir"
    ...
    def test__when_copying_directory__but_directory_exists__should_copy_into_existing_directory(self):
    ...
    def test__when_deleting_file__should_remove_file_from_fs(self):
        sut = self.create_filesystem()
        self.create_file(sut, self.SOURCE)
    ...
    def test__when_deleting_directory__should_call_fs_removetree(self):
        dir_path = "mydir"
        sut = self.create_filesystem()
    ...
    def test__when_deleting_file_but_does_not_exist__should_raise_file_not_found_error(self):
        sut = self.create_filesystem()

        with pytest.raises(FileNotFoundError):
            sut.delete(self.SOURCE)

    def test__when_copying_files_with_glob_pattern__it_copies_matching_files(self):
        sut = self.create_filesystem()
    ...
    def test__when_deleting_with_glob_pattern__it_deletes_matching_files(self):
        sut = self.create_filesystem()
        self.create_file(sut, "hello.txt")
        self.create_file(sut, "world.txt")
        self.create_file(sut, "nope.gif")
    ...
    def test__when_globbing__it_returns_matching_paths(self):
        sut = self.create_filesystem()
        self.create_file(sut, "hello.txt")
        self.create_file(sut, "world.txt")
        self.create_file(sut, "nope.gif")
