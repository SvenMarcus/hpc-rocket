...
def test_local_filesystem__when_creating_new_instance__should_open_fs_in_folder(
    osfs_type_mock: Mock,
):
...
def test__given_sshfilesystem__when_creating_new_instance__should_create_sshfs_with_connection_data(
    sshfs_type_mock: Mock,
) -> None:
...
def test__given_sshfilesystem__when_creating_new_instance_with_private_key__should_create_sshfs_with_connection_data(
    ...
    connection = ConnectionData(hostname="host", username="user", key="privatekey")
    sut = sshfilesystem(connection)
...
def test__given_sshfilesystem__when_creating_new_instance_with_keyfile__should_create_sshfs_with_connection_data(
    ...
    connection = ConnectionData(
        hostname="host", username="user", keyfile="~/path/to/keyfile"
    )
...
def test__when_ssh_connection_fails__should_raise_ssh_error(
    sshfs_type_mock: Mock,
) -> None:
